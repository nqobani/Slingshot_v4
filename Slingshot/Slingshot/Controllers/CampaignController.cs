...
namespace Slingshot.Controllers
{
    ...
    public class CampaignController : ApiController
    {
        ...
        [Route("add")]
        public Campaign addCampaign(string creatorId, string attechmentsJSONString=null, string campaignName = "No Name", Boolean prefared = false, string thumbnail = "HTTPS", string subject = "TESTIING", string HTML = "<!DOCTYPE html>", string status = "public")
        {
            UserService obj = new UserService();
